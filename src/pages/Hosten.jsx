...
export default function Hosten() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Fehler beim Erstellen des Dinners. Bitte versuche es erneut.')
    } finally {
      setSubmitting(false)
    }
  }
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <input
            ...
            type="text"
            name="title"
            placeholder="z.B. Pasta-Abend bei mir"
            value={form.title}
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            name="description"
            placeholder="Was erwartet die Gäste? Was gibt es zu essen?"
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            <label className="form-label">
              Uhrzeit <span className="required">*</span>
            </label>
            <input
              className="form-input"
              type="time"
        ...
        <div className="form-row">
          <div className="form-group">
            <label className="form-label">
              Ort/Stadt <span className="required">*</span>
            </label>
            <input
              className="form-input"
              type="text"
        ...
        <div className="form-row">
          <div className="form-group">
            <label className="form-label">
              Küche <span className="required">*</span>
            </label>
            <select
          ...
          <div className="form-group">
            <label className="form-label">
              Max. Gäste <span className="required">*</span>
            </label>
            <input
              className="form-input"
              type="number"
